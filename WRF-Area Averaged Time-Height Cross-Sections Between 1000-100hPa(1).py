...
tt_contours = plt.contourf(tt_mean.Time.values, p_mean, 
                             ...
                             cmap=get_cmap("viridis"), extend ='both')
plt.colorbar(tt_contours, ax=ax, pad=.05, label="Potential Temperature Difference")
...
qv_contours = plt.contourf(qv_mean.Time.values, p_mean, 
                             ...
                             cmap=get_cmap("viridis"), extend ='both')
plt.colorbar(qv_contours, ax=ax, pad=.05, label="Water Vapor Mixing Ratio Tendency Difference")
